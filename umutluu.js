...
client.on("guildMemberAdd", member => {
  ...
  let umutluu = new Discord.MessageEmbed()
    .setColor("#00ff00")
  ...
  client.channels.cache.get(kanal).send(umutluu);
});
...
client.on("guildMemberAdd", member => {
  const hosgeldin = new Discord.MessageEmbed()
    ...
    .setDescription("Seni aramız da görmekten onur ve şeref duyuyoruz, umutluu Code.")
   .setColor("#00ff00")
...
client.on('ready', () => {
  ...
  // Oynuyor Kısmı
    ...
    setInterval(() => {
      ...
      console.log (`umutluu Youtube    : Gelişmiş bot alt yapı!`);
      console.log ('_________________________________________');
